...
import {
  ...
  Activity, Headphones, Puzzle, Layers, Package, FileText,
} from 'lucide-react';
...
const mainNav = [
  ...
  { id: 'plans', label: 'الخطط والأسعار', icon: Package, path: ADMIN_ROUTES.PLANS, permission: PERMISSIONS.SETTINGS_VIEW },
  { id: 'templates', label: 'القوالب', icon: FileText, path: ADMIN_ROUTES.TEMPLATES, permission: PERMISSIONS.SUBSCRIBERS_VIEW, dividerAfter: true },
