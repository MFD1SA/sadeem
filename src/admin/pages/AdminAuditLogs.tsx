...
const EVENT_LABELS: Record<string, string> = {
  ...
  ai_reply_generated: 'رد AI تم إنشاؤه',
  ai_reply_failed: 'فشل رد AI',
  ai_limit_reached: 'حد AI وصل',
  template_matched: 'قالب مطابق',
  template_quota_exhausted: 'حصة القوالب نفدت',
  draft_created: 'مسودة أُنشئت',
  draft_edited: 'مسودة عُدّلت',
  draft_approved: 'مسودة وُوفق عليها',
  draft_rejected: 'مسودة رُفضت',
  draft_deferred: 'مسودة أُجّلت',
  reply_sent_google: 'رد أُرسل لـ Google',
  reply_auto_sent: 'رد أُرسل تلقائياً',
