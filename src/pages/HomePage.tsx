...
const T: Record<Lang, Record<string, any>> = {
  ar: {
    ...
    showcaseBlocks: [
      ...
      { title: 'كل تقييم فرصة. كل رد يصنع الفارق.', desc: 'استقبل تقييمات عملائك فورياً وردّ عليها بذكاء من داخل المنصة — سواء بالذكاء الاصطناعي أو يدوياً — بسرعة واحترافية تعزز ثقة العملاء.' },
