...
const T: Record<Lang, Record<string, any>> = {
  ar: {
    ...
    heroBtn: 'تواصل معنا',
    faqs: [
      { q: 'ما هي سيندا؟', a: 'سيندا حل سعودي متكامل لإدارة تقييمات Google Business، الردود الذكية بالذكاء الاصطناعي، تحليلات الأداء، وإدارة الفروع والفريق من مكان واحد.' },
      { q: 'هل يمكنني تجربة سيندا مجانًا؟', a: 'نعم، جميع الخطط تتضمن فترة تجريبية مجانية بدون الحاجة لبطاقة ائتمان. يمكنك البدء فورًا واستكشاف جميع المميزات.' },
      ...
      { q: 'هل أحتاج خبرة تقنية لاستخدام سيندا؟', a: 'لا، سيندا مصممة لتكون سهلة الاستخدام. كل ما تحتاجه هو ربط حساب Google Business الخاص بك والبدء في إدارة تقييماتك فورًا.' },
      ...
      { q: 'هل يدعم سيندا اللغة الإنجليزية؟', a: 'نعم، سيندا يدعم العربية والإنجليزية بالكامل ويمكنك التبديل بين اللغتين في أي وقت.' },
